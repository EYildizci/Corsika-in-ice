...
{
  itsGridVector.reserve(itsNumEntries);  // reserve space for entries to be generated in next step
  for (long i=0; i<itsNumEntries; ++i) { itsGridVector.push_back(T()); }  // create the empty entries
}
