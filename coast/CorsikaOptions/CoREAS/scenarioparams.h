...
public: 
  ScenarioParams(const string& parName, const string& parGroundFileName); ///< constructor creating scenario parName with associated ground file parGroundFileName
