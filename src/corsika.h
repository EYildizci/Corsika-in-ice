...
#endif
C --------------/CRGNUPR/------------------------
C  SE1(.)      = ARRAY FOR COLLISION PROBABILITY
...
#endif
C  VOLHEI      = HEIGHT OF SIMULATED VOLUME
...
/*-- Author :    The CORSIKA development group   21/04/1994 */
      ...
      DOUBLE PRECISION AATM(5),AATM0(5,0:29),BATM(5),BATM0(5,0:29),
     *                 CATM(5),CATM0(5,0:29),DATM(5)
      INTEGER          MODATM
#undef __ATMOSINC__
#endif
...
#ifdef __GNUPRINC__
/*-- Author :    The CORSIKA development group   21/04/1994 */
      COMMON /CRGNUPR/ SE1,SE14,SE16,SE40
      DOUBLE PRECISION SE1(3,1),SE14(3,14),SE16(3,16),SE40(3,40)
#undef __GNUPRINC__
#endif
...
/*-- Author :    The CORSIKA development group   21/04/1994 */
      ...
      DOUBLE PRECISION RDRES(2),RESRAN(1000000)
      INTEGER          IRESPAR
#undef __RESONINC__
#endif
...
#endif
#if __THIN__ || __MULTITHIN__
     *                 ,EEPP(MAXICOUNT),ELIM,RMAX,RMAX2
#endif
#if  __THIN__
     *                 ,WMAX,WMAX0,WMAXE,WMAXE0,WMAXEM
#endif
