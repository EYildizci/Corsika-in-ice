...
c-----------------------------------------------------------------------
c compilation:
c     gfortran -fbounds-check readtimes.f -o readtimes
c     f77 -fbounds-check readtimes.f -o readtimes
c     ifort -C -check bounds readtimes.f -o readtimes
c execution by script:
c     ./readtimes.sh cd9-e19m100as DAT0023
c     # to sum up time info from all files DAT0023??.lst
c-----------------------------------------------------------------------
cDAT401200.lst
...
c - - - - - - sum up time difference in hours:
         ...
         write(*,'(8x,a13,f21.4,'' hours ='',f10.4,'' days'')')
     +      czeile(1),hoursd,hoursd/24.
